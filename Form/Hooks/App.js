...
Mas é geralmente no INPUT  que tem um REGEX, pq no SELECT só há campos para a pessoa SELECIONAR ou não. NÃO EXISTE VALIDAÇÃO DE REGEX na seleção de um campo em si ou na seleção de um radio ou de um checkbox, então, só serve mesmo para input.
*/